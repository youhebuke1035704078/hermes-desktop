...
import { ApiClient } from './http-client'  // Now uses native WebSocket + Gateway protocol v3
...
const DEFAULT_CONFIG: Required<Omit<WebSocketConfig, 'auth' | 'getToken' | 'onUnauthorized'>> & { auth?: string; getToken?: () => string | null; onUnauthorized?: () => void } = {
  url: '',
  reconnect: true,
