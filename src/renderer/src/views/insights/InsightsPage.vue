...
import { AnalyticsOutline, RefreshOutline, TrendingUpOutline } from '@vicons/ionicons5'
  ...
  <NSpace vertical :size="16">
    ...
    <NCard>
      ...
      <NGrid cols="1 s:2 m:4" responsive="screen" :x-gap="10" :y-gap="10">
        <NGridItem>
          <NCard embedded :bordered="false" size="small" style="border-radius: 10px">
            <NText depth="3" style="font-size: var(--font-body-sm)">{{
              t('pages.insights.metrics.totalTokens')
            }}</NText>
        ...
        <NGridItem>
          <NCard embedded :bordered="false" size="small" style="border-radius: 10px">
            <NText depth="3" style="font-size: var(--font-body-sm)">{{
              t('pages.insights.metrics.totalCost')
            }}</NText>
            <div style="font-size: var(--font-metric); font-weight: 700; margin-top: 6px">
        ...
        <NGridItem>
          <NCard embedded :bordered="false" size="small" style="border-radius: 10px">
            <NText depth="3" style="font-size: var(--font-body-sm)">{{
              t('pages.insights.metrics.sessions')
            }}</NText>
            <div style="font-size: var(--font-metric); font-weight: 700; margin-top: 6px">
        ...
        <NGridItem>
          <NCard embedded :bordered="false" size="small" style="border-radius: 10px">
            <NText depth="3" style="font-size: var(--font-body-sm)">{{
              t('pages.insights.metrics.errorRate')
            }}</NText>
            <div style="font-size: var(--font-metric); font-weight: 700; margin-top: 6px">
      ...
      <div style="margin-top: 16px">
        <NText depth="3" style="font-size: var(--font-body-sm); display: block; margin-bottom: 6px">
        ...
        <NGrid cols="1 s:3" responsive="screen" :x-gap="10" :y-gap="10">
          <NGridItem>
            <NSpace vertical :size="2">
              <NSpace justify="space-between" :size="4">
                <NText style="font-size: var(--font-body-sm)">{{
                  t('pages.insights.input')
                }}</NText>
                <NText depth="3" style="font-size: var(--font-body-sm)">
              ...
              <NProgress
                type="line"
                :percentage="Math.round(inputSharePct)"
                :height="6"
          ...
          <NGridItem>
            <NSpace vertical :size="2">
              ...
              <NProgress
                type="line"
                :percentage="Math.round(outputSharePct)"
                :height="6"
                :show-indicator="false"
                color="#70c0e8"
              />
          ...
          <NGridItem>
            <NSpace vertical :size="2">
              ...
              <NProgress
                type="line"
                :percentage="Math.round(cacheReadSharePct)"
                :height="6"
                :show-indicator="false"
                color="#f0a020"
              />
      ...
      <NGrid cols="1 s:2" responsive="screen" :x-gap="10" :y-gap="10" style="margin-top: 12px">
        <NGridItem>
          <NSpace
            ...
            :size="4"
            style="padding: 8px; background: var(--n-color-embedded); border-radius: 8px"
          >
            <NText depth="3" style="font-size: var(--font-body-sm)">{{
              t('pages.insights.avgTokensPerSession')
            }}</NText>
        ...
        <NGridItem>
          ...
          >
            <NText depth="3" style="font-size: var(--font-body-sm)">{{
              t('pages.insights.avgCostPerSession')
            }}</NText>
      ...
      <div v-if="insightsStore.error" style="margin-top: 12px">
        <NText type="error" style="font-size: var(--font-body-sm)">{{ insightsStore.error }}</NText>
      </div>
    </NCard>
    ...
    <NCard v-if="insightsStore.dailyTrend.length > 0">
      ...
      <div class="trend-chart">
        <div v-for="day in insightsStore.dailyTrend" :key="day.date" class="trend-bar-wrap">
          <div class="trend-bar-value">{{ formatTokens(day.tokens) }}</div>
          <div class="trend-bar-container">
            <div
              class="trend-bar"
              :style="{
                height: insightsStore.maxDailyTokens
                  ? (day.tokens / insightsStore.maxDailyTokens) * 100 + '%'
                  : '0%'
              }"
            />
          </div>
      ...
      <NGridItem>
        <NCard>
          ...
          <NSpace vertical :size="8">
            ...
            <div v-for="(m, idx) in insightsStore.topModels" :key="m.model || idx" class="rank-row">
              <div class="rank-index">{{ idx + 1 }}</div>
              <div class="rank-info">
                <NText strong style="font-size: var(--font-body); display: block">
              ...
              <div class="rank-metric">
                <NText style="font-size: var(--font-body)">{{
          ...
          <NSpace vertical :size="8">
            ...
            >
              <NSpace justify="space-between" :size="4" style="margin-bottom: 4px">
                <NText strong style="font-size: var(--font-body)">{{
                  p.provider || t('pages.insights.unknown')
                }}</NText>
                <NText style="font-size: var(--font-body-sm)">{{
                  formatTokens(p.totals.totalTokens)
                }}</NText>
              </NSpace>
              <NProgress
                type="line"
                :percentage="Math.round(p.share)"
                :height="6"
                :show-indicator="false"
              />
            </div>
        ...
        <NCard>
          ...
          <NSpace vertical :size="6">
            ...
            >
              ...
              <div class="rank-info">
                <NText strong style="font-size: var(--font-body)">{{
                  a.agentId || t('pages.insights.unknown')
                }}</NText>
              </div>
              <div class="rank-metric">
                <NText style="font-size: var(--font-body)">{{
                  formatTokens(a.totals.totalTokens)
                }}</NText>
              </div>
            </div>
          </NSpace>
        ...
        <NCard>
          ...
          <NSpace vertical :size="6">
            ...
            >
              ...
              <div class="rank-info">
                <NText strong style="font-size: var(--font-body)">{{
                  c.channel || t('pages.insights.unknown')
                }}</NText>
              </div>
              <div class="rank-metric">
                <NText style="font-size: var(--font-body)">{{
