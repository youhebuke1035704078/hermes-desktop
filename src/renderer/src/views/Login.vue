...
import { NButton, NText, NAlert, NSpin, NInput, NForm } from 'naive-ui'
...
let mountUnsubscribe: (() => void) | null = null
...
onMounted(async () => {
  ...
  if (!authEnabled) {
    ...
    mountUnsubscribe = websocketStore.subscribe('stateChange', () => {
      checkConnection()
    })
