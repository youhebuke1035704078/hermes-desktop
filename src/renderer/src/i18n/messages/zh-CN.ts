  ...
  pages: {
    ...
    skills: {
      ...
      groups: {
        ...
        bundled: {
          title: '系统内置插件',
          description: '随 Hermes 一起提供（可控制是否在 Chat 中可选）',
          empty: '当前没有内置插件',
        },
      },
      sources: {
    ...
    channels: {
      ...
      groups: {
        title: '群聊权限管理',
        hint: '配置群聊的功能权限白名单。每个群可独立开通 main（主对话）、cron（定时任务投递）、skill（技能调用）权限。新增群聊默认开启全部权限。',
        columnId: '群聊',
        addPlaceholderId: '输入群聊 ID（如 oc_xxx）',
        addPlaceholderName: '备注名（可选）',
        add: '添加',
        empty: '暂无群聊权限配置',
        idRequired: '请输入群聊 ID',
        duplicate: '该群聊已存在',
    ...
    backup: {
      ...
      info: {
        title: '备份说明',
        whatIsBackup: '什么是备份？',
        backupContent: '备份包含：数据库（SQLite）、Hermes 配置文件、Web Admin 配置、会话数据、工作区元数据、Wizard 数据库等。',
        restoreNote: '恢复提示',
      ...
      progress: {
        ...
        wizardDb: '正在备份项目数据库...',
        envConfig: '正在备份环境配置...',
        hermesBackup: '正在备份 Hermes 数据...',
        creatingZip: '正在创建压缩包...',
        extractingZip: '正在解压备份文件...',
        restoringHermes: '正在恢复 Hermes 数据...',
