export default {
  ...
  components: {
    connectionStatus: {
      installingIn: '{count}s 后自动安装...',
      ready: '新版本已就绪',
      downloading: '下载中 {percent}%',
      updateDetected: '检测到新版本',
      checking: '检查中...',
      upToDate: '已是最新',
      updateFailed: '更新失败',
  ...
  pages: {
    connection: {
      subtitle: '连接到你的 Hermes 服务器',
      autoConnecting: '正在连接本地 Hermes 服务器…',
      ...
      platformHint: '在目标主机上部署 Hermes 服务后，使用此客户端远程连接管理',
      modalTitleAdd: '添加服务器',
      modalTitleEdit: '编辑服务器',
      labelAddress: '地址',
      labelAddressRequired: '(必填，决定连接目标)',
      placeholderAddress: '例如：192.168.1.100:3002',
      labelName: '名称',
      labelNameOptional: '(选填，仅用于显示)',
      placeholderName: '例如：我的 Mac Mini',
      labelPlatform: '平台',
      labelUsername: '用户名',
      labelUsernameOptional: '(选填，仅用于显示)',
      placeholderUsername: '任意标识（如 admin）',
      labelToken: '访问\n令牌',
    ...
    channels: {
      ...
      refresh: '刷新',
      manageSettings: '前往设置',
      empty: '尚未配置任何渠道，请前往设置中添加渠道凭证',
      unavailableHermesRest: 'Hermes REST 模式下不支持渠道管理，请连接 ACP Gateway 后查看',
      searchPlaceholder: '搜索 ID / 账号名',
      platformAll: '所有平台',
      statusAll: '所有状态',
    ...
    memory: {
      title: '记忆与文档管理',
      coveredDocsPrefix: '覆盖 Hermes 官方可管理文档：',
      coveredDocsSuffix: '。',
    ...
    cron: {
      ...
      batchSetModelSuccess: '已修改 {count} 个任务的模型',
      batchSetModelFailed: '批量修改模型失败',
    ...
    sessions: {
      ...
      list: {
        ...
        newFailed: '启动新会话失败',
        batchSetModel: '统一模型',
        batchModelPlaceholder: '选择目标模型',
        batchSetModelApply: '确认修改',
        batchSetModelSuccess: '已修改 {count} 个会话的模型',
        batchSetModelFailed: '批量修改模型失败',
        createSession: '新建会话',
    ...
    settings: {
      ...
      themeDark: '深色模式',
      about: '关于',
      aboutLine1: 'Hermes 远程管理终端，连接并管理你的 Hermes AI 实例',
      aboutLine2: '基于 Electron + Vue 3 + Naive UI 构建',
      ...
      hermesConfigDesc: '编辑 ~/.hermes/config.yaml',
      hermesEnv: '环境变量',
      hermesEnvDesc: '编辑 ~/.hermes/.env',
      loadingFile: '加载中...',
      ...
      restarting: '重启中...',
      restartSuccess: 'Hermes 服务已重启',
      restartFailed: '重启失败',
      restartTip: '修改配置后需要重启 Hermes 服务才能生效',
      fileNotFound: '文件不存在，保存后将自动创建',
      serverInfo: '服务器信息',
      serverPlatform: '平台',
      serverModel: '模型',
      serverLocalOnly:
    ...
    system: {
      ...
      restart: {
        title: '网关控制',
        warning: '重启网关会导致所有活跃连接短暂中断，正在执行的任务可能受到影响。',
        description: '重启 Hermes Gateway 进程',
        action: '重启网关',
        confirmTitle: '确认重启网关',
        confirmMessage: '重启后所有 WebSocket 连接将断开，客户端会自动重连。确定要继续吗？',
        confirm: '确认重启',
        delayLabel: '延迟',
        delayUnit: '秒',
    ...
    files: {
      ...
      operationNotSupported: '该操作在直连 Gateway 模式下暂不支持',
      pdfNotSupported: 'PDF 预览在直连 Gateway 模式下暂不支持',
      binaryNoPreview: '二进制文件暂不支持预览',
      editor: {
        title: '编辑器',
        heading1: '一级标题',
        heading2: '二级标题',
    ...
    agents: {
      ...
      form: {
        ...
        workspace: '工作区',
        workspacePlaceholder: '例如：~/.hermes/workspace-work',
        name: '名称',
        namePlaceholder: '例如：Hermes',
        theme: '主题',
        themePlaceholder: '例如：space lobster',
        emoji: 'Emoji',
        emojiPlaceholder: '例如：🦞',
        avatar: '头像',
        avatarPlaceholder: '例如：avatars/hermes.png',
        model: '模型',
    ...
    backup: {
      ...
      downloadSuccess: '备份已导出',
      downloadFailed: '下载备份失败：{error}',
      restoreSuccess: '备份已恢复，部分改动可能需要重启服务',
      restoreFailed: '恢复备份失败：{error}',
      uploadSuccess: '备份上传成功：{filename}',
      uploadFailed: '上传备份失败：{error}',
      restoreConfirmTitle: '确认恢复备份',
      restoreConfirmContent: '恢复备份 {filename} 将覆盖当前数据。该操作不可撤销，继续吗？',
      restoreConfirmOk: '确认恢复',
    ...
    logs: {
      ...
      empty: '暂无日志',
      cleared: '日志已清空',
      unavailableHermesRest: 'Hermes REST 模式下不支持实时日志，请连接 ACP Gateway 后查看',
      searchPlaceholder: '搜索日志内容',
      levelFilter: '按级别筛选',
      subsystemFilter: '按子系统筛选',
      levelAll: '所有级别',
      subsystemAll: '所有子系统',
      autoScroll: '自动滚动',
      showing: '显示 {filtered} / 共 {total}',
      clear: '清空缓冲',
      reload: '重新加载',
      scrollBottom: '滚到底部',
      metrics: {
    ...
    insights: {
      title: '运营洞察',
      refresh: '刷新',
      unavailableHermesRest: 'Hermes REST 模式下不支持用量统计，请连接 ACP Gateway 后查看',
      empty: '暂无数据',
      unknown: '未知',
      calls: '次',
      ...
      avgCostPerSession: '平均费用 / 会话',
      dailyTrend: '每日趋势',
      topModels: 'Top 模型',
      topProviders: 'Top 服务商',
      topAgents: 'Top 智能体',
      topChannels: 'Top 渠道',
      topTools: '热门工具',
      metrics: {
