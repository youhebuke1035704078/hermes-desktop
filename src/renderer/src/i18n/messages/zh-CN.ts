export default {
  ...
  pages: {
    connection: {
      ...
      platformHint: '在目标主机上部署 OpenClaw Admin 服务后，使用此客户端远程连接管理',
      modalTitleAdd: '添加服务器',
      ...
      labelPlatform: '平台',
      labelUsername: '用户名',
      placeholderUsername: '任意标识（如 operator）',
      labelToken: 'Gateway 令牌',
      placeholderToken: 'openclaw.json → gateway.auth.token',
      tokenHint: '令牌在服务器的 openclaw.json 中配置（gateway.auth.token），可通过 openclaw config get gateway.auth.token 查看',
      probeButton: '检测服务器',
    ...
    settings: {
      ...
      themeDark: '深色模式',
      about: '关于',
      aboutLine1: 'OpenClaw 远程管理终端，连接并管理你的 OpenClaw AI 实例',
    ...
    system: {
      ...
      restart: {
        ...
        description: '重启 OpenClaw Gateway 进程',
        action: '重启网关',
        confirmTitle: '确认重启网关',
