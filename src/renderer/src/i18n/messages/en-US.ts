export default {
  ...
  pages: {
    connection: {
      ...
      connectFailedAuth: 'Connection failed. Check the server address and Gateway token.',
      deleted: 'Deleted',
    ...
    skills: {
      ...
      groups: {
        ...
        bundled: {
          ...
          description: 'Provided with Hermes (can control whether visible in Chat)',
    ...
    channels: {
      ...
      groups: {
        ...
        hint: 'Configure per-group feature permissions. Each group can independently enable main (conversation), cron (scheduled task delivery), and skill (skill invocation). New groups default to all permissions enabled.',
        columnId: 'Group',
        addPlaceholderId: 'Enter group chat ID (e.g. oc_xxx)',
        addPlaceholderName: 'Label (optional)',
        add: 'Add',
        empty: 'No group permissions configured',
        idRequired: 'Please enter a group chat ID',
        duplicate: 'This group already exists',
        perm: {
          main: 'Main',
          cron: 'Cron',
          skill: 'Skill',
    ...
    settings: {
      ...
      serverModel: 'Model',
      serverLocalOnly: 'Version updates, config editing, and restart are only available for local connections',
    ...
    backup: {
      ...
      info: {
        ...
        backupContent: 'Backup includes: database (SQLite), Hermes configuration, Web Admin config, sessions data, workspace metadata, Wizard database, etc.',
      ...
      progress: {
        ...
        hermesBackup: 'Backing up Hermes data...',
        creatingZip: 'Creating archive...',
        extractingZip: 'Extracting backup file...',
        restoringHermes: 'Restoring Hermes data...',
