export default {
  ...
  pages: {
    connection: {
      subtitle: 'Connect to your OpenClaw server',
      ...
      platformHint: 'Deploy the OpenClaw Admin service on the target host, then use this client to connect and manage remotely',
      ...
      placeholderUsername: 'Any identifier (e.g. operator)',
      labelToken: 'Gateway Token',
      placeholderToken: 'openclaw.json → gateway.auth.token',
      tokenHint: 'The token is configured in openclaw.json (gateway.auth.token). Run: openclaw config get gateway.auth.token',
    ...
    settings: {
      ...
      themeDark: 'Dark',
      about: 'About',
      aboutLine1: 'OpenClaw remote management terminal for connecting and managing your OpenClaw AI instances',
